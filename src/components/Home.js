...
const Home = ({ home, provider, account, escrow, togglePop }) => {
    ...
    const fetchDetails = async () => {
        ...
        console.log("🚀 ~ fetchDetails ~ buyer:", buyer)
        setBuyer(buyer)
        ...
        console.log("🚀 ~ fetchDetails ~ seller:", seller)
        setSeller(seller)
        ...
        console.log("🚀 ~ fetchDetails ~ lender:", lender)
        setLender(lender)
        ...
        console.log("🚀 ~ fetchDetails ~ inspector:", inspector)
